...
def assistant(command):
    ...
    elif '''hows the weather in ''' in command:
        reg_ex = re.search('''hows the weather in (.*)''', command)
        if reg_ex:
            city = reg_ex.group(1)
...
detector = snowboydecoder.HotwordDetector("/home/pho3nix/Tools/ApolloAI/snow/hotword/Apollo.pmdl", 
